...
| broker.image.repository | string | `"xentra-ai/broker"` |  |
| broker.image.sha | string | `""` |  |
| broker.image.tag | string | `"v0.1.0"` |  |
| broker.imagePullSecrets | list | `[]` |  |
| broker.nameOverride | string | `""` |  |
| broker.nodeSelector | object | `{}` | Node labels for the kube-guardian broker pod assignment |
...
| controller.image.repository | string | `"nginx"` |  |
| controller.image.tag | string | `""` | Overrides the image tag. |
| controller.imagePullSecrets | list | `[]` |  |
| controller.nameOverride | string | `""` |  |
| controller.nodeSelector | object | `{}` | Node labels for the kube-guardian controller pod assignment |
...
| database.image.repository | string | `"nginx"` |  |
